...
namespace
{
	...
	TMap<FName, FKodoStructurePreset> BuildRegistry()
	{
		...
		// --- wall (WC3 "Spiked Box": 50g / 15hp — kodo_balance_data.md §2/§5) ---
		{
			...
			// WC3 walls cost 50g and are fragile (15hp). Kept 1x1 so players can carve
			// 1-cell gaps that block 2x2 Kodos. Upgrade tiers preserved structurally,
			// tuned toward the WC3 "Magical Wall" (30hp) tier.
			P.GoldCost = 50; P.MaxHp = 15.f; P.ConstructionSeconds = 2.5f; P.bIs2x2 = false; P.Food = 1.f;
		...
		// --- magic_wall (WC3 "Magical Wall": 5g / 30hp — sturdier 1x1 wall tier) ---
		{
			...
			P.GoldCost = 5; P.WoodCost = 0; P.MaxHp = 30.f; P.ConstructionSeconds = 2.5f; P.bIs2x2 = false; P.Food = 1.f;
		...
		// --- basic_tower (WC3 "Basic Tower": 75g+30l / 40hp / 47dmg / 1.1cd — §2/§5) ---
		{
			...
			P.GoldCost = 75; P.WoodCost = 30; P.MaxHp = 40.f; P.RangeTiles = 5.5f; P.CooldownSeconds = 1.1f; P.Damage = 47.f; P.bIs2x2 = false; P.Food = 2.f;
		...
		// --- arrow (WC3 rapid basic o00A: 75g+30l / fast cd / low dmg — §2/§5) ---
		{
			...
			P.GoldCost = 75; P.WoodCost = 30; P.MaxHp = 40.f; P.RangeTiles = 5.5f; P.CooldownSeconds = 0.33f; P.Damage = 6.f; P.bIs2x2 = false; P.Food = 2.f;
		...
		// --- frost (towers.js:57-73) ---
		{
			...
			P.Special = "frost"; P.bIs2x2 = false; P.Food = 2.f;
		...
		// --- stun (towers.js:74-91) ---
		{
			...
			P.Special = "stun"; P.RequiresUpgrade = "stunUnlocked"; P.bIs2x2 = false; P.Food = 2.f;
		...
		// --- aoe (towers.js:92-109) ---
		{
			...
			P.Special = "aoe"; P.RequiresUpgrade = "aoeUnlocked"; P.bIs2x2 = false; P.Food = 2.f;
		...
		// --- multishot (towers.js:110-127) ---
		{
			...
			P.Special = "multishot"; P.RequiresUpgrade = "multishotUnlocked"; P.bIs2x2 = false; P.Food = 2.f;
		...
		// --- aura (towers.js:128-145) ---
		{
			...
			P.Special = "aura"; P.RequiresUpgrade = "auraUnlocked"; P.bIs2x2 = false; P.Food = 2.f;
		...
		// --- mine_shaft (towers.js:146-163) ---
		{
			...
			P.GoldCost = 100; P.WoodCost = 50; P.MaxHp = 400.f; P.Special = "mine_shaft"; P.bIs2x2 = true; P.Food = 4.f;
		...
		// --- lumber_mill (towers.js:164-181) ---
		{
			...
			P.GoldCost = 80; P.WoodCost = 20; P.MaxHp = 300.f; P.Special = "lumber_mill"; P.bIs2x2 = true; P.Food = 4.f;
		...
		// --- command_center (WC3 Castle hmtt: 2000g + 500l / 1000hp — §2/§5) ---
		{
			...
			P.GoldCost = 2000; P.WoodCost = 500; P.MaxHp = 1000.f; P.Special = "command_center"; P.bIs2x2 = true; P.Food = 0.f;
		...
		// --- admin_tower (debug/control building, top-right corner; not a shooting tower) ---
		{
			...
			P.GoldCost = 0; P.WoodCost = 0; P.MaxHp = 999999.f; P.Special = "admin_tower"; P.bIs2x2 = true; P.Food = 0.f;
		...
		// --- upgrade_center (separate tech building: hosts all tower research) ---
		{
			...
			P.GoldCost = 50; P.WoodCost = 0; P.MaxHp = 250.f; P.Special = "upgrade_center"; P.bIs2x2 = true; P.Food = 4.f;
